...
SECRET_KEY = 'django-insecure-3%w%jpk=$nkxz6fa9w2$sf#8wk6s7c8war7a2ef*^$_tpnvc7^'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # Frontend React rodando nesta porta
]
...
INSTALLED_APPS = [
    ...
    'corsheaders', # Permitir requisições externas
